...
function Dashboard() {
  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,_#f5e6d3,_transparent_35%)]">
    <header className="mx-auto flex max-w-7xl items-center justify-between px-5 py-8 lg:px-10">
      ...
      <Avatar className="size-12 border-2 border-white shadow-sm"><AvatarFallback className="bg-red-700 font-bold text-white">AL</AvatarFallback></Avatar>
    </header>
    <main className="mx-auto grid max-w-7xl gap-6 px-5 pb-12 lg:grid-cols-3 lg:px-10">
