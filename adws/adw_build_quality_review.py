...
Usage:
    uv run adws/adw_build_quality_review.py "<prompt or path/to/prompt.md>" --projects <project[,project...]> [--config adws/adw_codectory_config/codectory.config.yaml] [--adw-id a1b2c3d4]
