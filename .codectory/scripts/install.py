...
# dependencies = []
# ///
"""/install — stamp the CODECTORY factory from the skill into the cwd. Idempotent.
...
def main() -> int:
    ...
    stamp(TEMPLATES / "agents.yaml",
          root / "adws" / "adw_codectory_config" / "agents.yaml",
          args.force, stamped, skipped)
    ...
    print(f"codectory installed into {root}")
