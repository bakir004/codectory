...
Usage:
    uv run adws/adw_{name}.py "<prompt or path/to/prompt.md>" [--config adws/adw_codectory_config/codectory.config.yaml] [--adw-id a1b2c3d4]
...
from adw_modules.data_types import AgentCall, LaunchOptions, PhaseParams, {imports}
...
if __name__ == "__main__":
    ...
    sys.exit(main(utils.resolve_prompt(args.prompt), args.projects, args.config,
                  args.adw_id, args.continue_instruction, args.clarification))
'''
