...
- Use the Context7 CLI through `bash` for documentation lookup. Start with `context7 --help` if its syntax is unfamiliar; use its library resolution and documentation commands rather than guessing from memory.
