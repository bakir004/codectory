...
Two keys drive it, both in codectory.config.yaml:
...
from .data_types import AgentConfig, CODECTORYConfig
...
def always_writable(cfg: CODECTORYConfig) -> list[str]:
...
def permitted(path: str, agent: AgentConfig, cfg: CODECTORYConfig) -> bool:
