...
Usage:
    uv run adws/adw_document.py "<prompt or path/to/prompt.md>" [--base main] [--config adws/adw_codectory_config/codectory.config.yaml] [--adw-id a1b2c3d4]
...
def main(prompt: str, projects: str, base: str = "main",
...
if __name__ == "__main__":
    ...
    sys.exit(main(utils.resolve_prompt(args.prompt), args.projects, args.base, args.config, args.adw_id, args.continue_instruction, args.clarification))
